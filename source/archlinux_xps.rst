...
J'ai récemment eu une nouvelle machine (changement professionnel) cette machine est un `DELL XPS 9360 (de 2017) fourni avec Ubuntu <http://www.dell.com/en-us/shop/dell-laptops/xps-13-laptop/spd/xps-13-9360-laptop>`_ . C'est vraiment une superbe machine un 13 pouces dans un gabarit d'un 11… Bref génial !
